...
# lookalike_for_brands documentation build
...
from lookalike_for_brands import __version__ as release

# -- Project information -----------------------------------------------------

project = "lookalike_for_brands"
author = "Kedro"
...
htmlhelp_basename = "lookalike_for_brandsdoc"
...
latex_documents = [
    (
        master_doc,
        "lookalike_for_brands.tex",
        "lookalike_for_brands Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "lookalike_for_brands",
        "Project lookalike_for_brands codebase.",
        "Data-Science",
    )
]
